                ...
                <div className="space-y-3">
                  ...
                  {q.question_type === 'code' && q.test_cases && (
                    <div className="bg-black/40 p-4 rounded-xl text-sm font-mono text-white/70 overflow-auto max-h-32">
                      <p className="mb-2 font-semibold text-white/90">Test Cases ({q.test_cases.length}):</p>
                ...
                <div>
                  ...
                  {q.question_type === 'code' && q.test_cases && (
                     <div className="bg-white/5 p-3 rounded-lg mb-3">
                        ...
                        <p className="text-xs text-white/50">{q.test_cases.length} hidden test cases generated by AI.</p>
                     </div>
                  )}
