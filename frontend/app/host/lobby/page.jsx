...
import { ArrowLeft, Play, QrCode, Copy, Check } from "lucide-react";
        ...
        {joinUrl && (
          <div className="card mb-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-display font-bold">QR Code & Direct Link</h3>
            </div>
            <p className="text-white/60 text-sm mb-4">
              Players can scan the QR code or open the direct link to join with just Name and Roll Number (no code needed).
            </p>
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
              {qrCode && (
                <div className="flex-shrink-0 bg-white p-3 rounded-lg">
                  <img src={qrCode} alt="Join QR Code" className="w-40 h-40" />
                </div>
              )}
              <div className="flex-1 min-w-0 w-full">
                <label className="block text-sm text-white/70 mb-2">Direct Link</label>
